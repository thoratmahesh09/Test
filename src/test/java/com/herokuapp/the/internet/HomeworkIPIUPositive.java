...
public class HomeworkIPIUPositive {
	...
	@Test(priority = 1)
	public void incorrectPasswordPass() {
		
		System.out.println("Starting Incorrect pasword test with wrong password");
		//open test page
	...
	public void incorrectUsername() {
		...
		System.out.println("Starting incorrect username test with Wrong Username");
		//open test page
		String url = "https://the-internet.herokuapp.com/login";
		CHK.get(url);
		System.out.println("Page is opened");
